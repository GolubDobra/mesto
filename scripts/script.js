...
let inputDescriptions = form.querySelector('.form__input-descriptions');
...
function openForm() {
   ...
   formContainer.classList.toggle('form-wrapper');
   formContainer.classList.toggle('form__dark');
...
let closeBtn = document.querySelector('.form__hidden-btn');
